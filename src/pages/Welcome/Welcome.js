        ...
        <div className="welcome-container container-fluid vh-100">
          <div className='row mt-3'>            
            <div className='col-12'>
              <h4 className='fw-bold mb-0'> Welcome <span className="text-primary text-capitalize">"John Doe"</span>, Good day!</h4>
            ...
            <div className="col-md-4 col-12 d-flex flex-column">
              <div className="user-info-card card border-0 shadow-sm h-100 rounded-2">
                <div className="card-body p-0">
                  <div className='p-4'>
                    <h5 className="card-title text-primary fw-bold mb-2 text-capitalize">"John Doe"</h5>
                    <p className="card-text mb-3">Emp Num: "123456"</p>
                  </div>

                  <div className='card-separator bg-dark bg-opacity-10 position-relative'></div>

                  <div className='p-4'>

                    <p className="card-text mb-3">Test test</p>

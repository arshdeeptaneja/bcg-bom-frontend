...
export default function AnnualAppraisalHome() {
    ...
    <div className="pageWrapper">
      ...
      <div className="kpi-tabs mt-3 d-flex flex-row gap-3">
        <KpiTab
          heading="Appraisee"
          kpiData={[
            { value: 1, label: 'Appraisals to be filled' },
            { value: 1, label: 'Pending Appraisals(s)' },
          ]}
          onClick={() => {
            navigate(
              `/annual/appraisee/appraisee-dashboard?financialYear=${financialYear}&appraisalPeriod=${appraisalPeriod}&quarter=${selectedQuarter}`
            );
          }}
        />
          ...
          onClick={() => {
            navigate(
              `/appraiser/dashboard?financialYear=${financialYear}&appraisalPeriod=${appraisalPeriod}&quarter=${selectedQuarter}`
            );
          }}
        />
      </div>
